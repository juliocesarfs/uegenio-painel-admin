 ...
 */
@Injectable()
export class ProdutoListResolve implements Resolve<any> {
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<any> {
    ...
    return new Observable(observer => {
      const filtro: FiltroProdutoDTO = new FiltroProdutoDTO();
      filtro.nome = '%%%%';
      this.produtoClientService.getByFiltro(filtro).subscribe(
        data => {
          observer.next(data);
          observer.complete();
        },
