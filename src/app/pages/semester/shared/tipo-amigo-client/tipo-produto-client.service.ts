...
export class SemesterClientService {
  ...
  public getAll(): Observable<any> {
    return this.http.get(`${environment.urlApi}/semester/`);
  }
  ...
  public salvar(usuario: any): Observable<any> {
    ...
    if (usuario.id) {
      result = this.http.put(`${environment.urlApi}/semester/${usuario.id}`, usuario);
    } else {
      result = this.http.post(`${environment.urlApi}/semester/`, usuario);
    }
    return result;
  }
  ...
  public remover(semester: any): Observable<any> {
    ...
    result = this.http.delete(`${environment.urlApi}/semester/${semester.id}`, {});
