 ...
 */
@Injectable()
export class TeacherListResolve implements Resolve<any> {
  ...
  constructor(
    ...
    private usuarioClientService: TeacherClientService,
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<any> {
    ...
    return new Observable(observer => {
      const filtro: FiltroTeacherDTO = new FiltroTeacherDTO();
      filtro.nome = '%%%%';
