...
export class VendaConsultaMComponent extends  AbstractComponent implements OnInit {
  public canvg;
  ...
  customizeTooltip(arg: any) {
    ...
    return {
      text: `<span class='title'>Valor Vendido No Mes:</span><br />&nbsp;<br />`
                +  `R$: ${
        arg.valueText} `,
    };
  }
...
*/
  ...
  public getValor(){
    ...
    console.log("Objeto Filtrado",this.valorItemVenda);
    for(i=0;i<this.valorItemVenda.length;i++){
  ...
  public valoresClientes(){
    ...
    console.log("Clientes Cadastrad",this.objetoFiltradoCliente)
  ...
  public salvar(vendaDataInicial: any, vendaDataFinal: any, form: NgForm, event: any) {
    ...
    if (form.valid) {
     ...
     this.dadosVenda();
     this.valorCerto();
     console.log("reduzidoooooooo",this.objetosFiltrados);
