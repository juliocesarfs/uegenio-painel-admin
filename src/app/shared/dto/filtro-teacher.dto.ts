...
export class FiltroTeacherDTO {
     ...
     * @param jsonData
     */
    static fromJson(jsonData: any): FiltroTeacherDTO {
        return Object.assign(new FiltroTeacherDTO(), jsonData);
    }

    /**
     * Retorna uma nova instancia de FiltroDTO
     */
    static getInstace(): FiltroTeacherDTO {
        return new FiltroTeacherDTO();
    }
